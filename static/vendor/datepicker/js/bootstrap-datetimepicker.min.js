  ...
  function i(i, p) {
    ...
    function c(e) {
      var t =
        null == e
          ? _()
          : _.isDate(e) || _.isMoment(e)
          ? _(e)
          : a()
          ? _.tz(e, B, p.useStrict, p.timeZone)
          : _(e, B, p.useStrict);
      ...
      var e,
        ...
        o = [
            ...
            a.append(
              $("<td>").append(
                $("<a>")
                  ...
                  .append($("<i>").addClass(p.icons.down))
              )
            )),
          d("m") &&
            (d("h") &&
              (e.append($("<td>").addClass("separator")),
              t.append($("<td>").addClass("separator").html(":")),
          ...
          $("<div>")
            ...
            .append(
              $("<table>").addClass("table-condensed").append([e, t, a])
            )),
        ];
              ...
              $("<tr>")
                .append(
                  $("<th>")
                    ...
                    .append($("<i>").addClass(p.icons.previous))
                )
                .append(
                  $("<th>")
                ...
                .append(
                  $("<th>")
                    ...
                    .append($("<i>").addClass(p.icons.next))
                )
            )),
            (a = $("<tbody>").append(
              $("<tr>").append(
                $("<td>").attr("colspan", p.calendarWeeks ? "8" : "7")
              )
            )),
            [
              $("<div>")
          ...
          .append(
            ...
            p.showTodayButton &&
              e.push(
                $("<td>").append(
                  $("<a>")
                    .attr({ "data-action": "today", title: p.tooltips.today })
                    .append($("<i>").addClass(p.icons.today))
                )
              ),
            !p.sideBySide &&
              u() &&
              ...
              e.push(
                $("<td>").append(
                  $("<a>")
                    ...
                    .append($("<i>").addClass(p.icons.time))
                )
              ),
            p.showClear &&
              e.push(
                $("<td>").append(
                  $("<a>")
                    .attr({ "data-action": "clear", title: p.tooltips.clear })
                    .append($("<i>").addClass(p.icons.clear))
                )
              ),
            p.showClose &&
              e.push(
                $("<td>").append(
                  $("<a>")
                    .attr({ "data-action": "close", title: p.tooltips.close })
                    .append($("<i>").addClass(p.icons.close))
                )
              ),
            $("<table>")
              .addClass("table-condensed")
      ...
      if (
        ("auto" === n &&
          (n =
            ...
            N.height() + i.outerHeight() < a.top
              ? "top"
              : "bottom"),
        "auto" === r &&
          (r =
            e.width() < a.left + N.outerWidth() / 2 &&
            a.left + N.outerWidth() > $(window).width()
              ? "right"
              : "left"),
        "top" === n
    ...
    function r(e) {
      "y" === e && (e = "YYYY"),
        m({ type: "dp.update", change: e, viewDate: H.clone() });
    }
    function o(e) {
      N &&
    ...
    function h(e, t) {
      ...
      if (
        ...
        !(
          (p.disabledDates &&
            "d" === t &&
            ((a = e), !0 === p.disabledDates[a.format("YYYY-MM-DD")])) ||
          (p.enabledDates &&
            "d" === t &&
            ((n = e), !0 !== p.enabledDates[n.format("YYYY-MM-DD")])) ||
          (p.minDate && e.isBefore(p.minDate, t)) ||
          (p.maxDate && e.isAfter(p.maxDate, t)) ||
          (p.daysOfWeekDisabled &&
            "d" === t &&
            -1 !== p.daysOfWeekDisabled.indexOf(e.day())) ||
          (p.disabledHours &&
            ("h" === t || "m" === t || "s" === t) &&
            ((r = e), !0 === p.disabledHours[r.format("H")])) ||
          (p.enabledHours &&
            ("h" === t || "m" === t || "s" === t) &&
            ((i = e), !0 !== p.enabledHours[i.format("H")]))
        )
      ) {
    ...
    function s() {
      ...
      if (u()) {
        for (
          ...
          0 === e.weekday() &&
            ((t = $("<tr>")),
            p.calendarWeeks && t.append('<td class="cw">' + e.week() + "</td>"),
            d.push(t)),
            (l = ["day"]),
          ...
          (function () {
            ...
            for (
              a.eq(0).find("span").attr("title", p.tooltips.prevCentury),
                ...
                (n.isSame(_({ y: 1900 })) ||
                  (p.minDate && p.minDate.isAfter(n, "y"))) &&
                  a.eq(0).addClass("disabled"),
                a.eq(1).text(n.year() + "-" + r.year()),
                (n.isSame(_({ y: 2e3 })) ||
                  (p.maxDate && p.maxDate.isBefore(r, "y"))) &&
              ...
              (e = n.year() + 12),
                (o =
                  p.minDate &&
                  p.minDate.isAfter(n, "y") &&
                  p.minDate.year() <= e),
                (s =
                  p.maxDate &&
                  p.maxDate.isAfter(n, "y") &&
                  p.maxDate.year() <= e),
                (d +=
    ...
    function e() {
      ...
      Y ||
        ((e = N.find(".timepicker [data-action=togglePeriod]")),
        (t = E.clone().add(12 <= E.hours() ? -12 : 12, "h")),
        e.text(E.format("A")),
        h(t, "h") ? e.removeClass("disabled") : e.addClass("disabled")),
        ...
        (function () {
          var e = N.find(".timepicker-hours table"),
            ...
            n = $("<tr>");
          for (
            11 < H.hour() && !Y && t.hour(12);
            t.isSame(H, "d") &&
            (Y || (H.hour() < 12 && t.hour() < 12) || 11 < H.hour());

          )
            t.hour() % 4 == 0 && ((n = $("<tr>")), a.push(n)),
              n.append(
        ...
        (function () {
          for (
            var e = N.find(".timepicker-minutes table"),
              t = H.clone().startOf("h"),
              a = [],
              n = $("<tr>"),
              r = 1 === p.stepping ? 5 : p.stepping;
            H.isSame(t, "h");

          )
            t.minute() % (4 * r) == 0 && ((n = $("<tr>")), a.push(n)),
              n.append(
        ...
        (function () {
          for (
            var e = N.find(".timepicker-seconds table"),
              t = H.clone().startOf("m"),
              a = [],
              n = $("<tr>");
            H.isSame(t, "m");
    ...
    function w(e) {
      ...
      if (!e)
        return (
          ...
          I.val(""),
          i.data("date", ""),
          m({ type: "dp.change", date: !1, oldDate: t }),
          void y()
        );
      if (
        ((e = e.clone().locale(p.locale)),
        a() && e.tz(p.timeZone),
        1 !== p.stepping)
      )
        for (
          e
            .minutes(Math.round(e.minutes() / p.stepping) * p.stepping)
            .seconds(0);
          p.minDate && e.isBefore(p.minDate);

        )
          e.add(p.stepping, "minutes");
      h(e)
        ? ((H = (E = e).clone()),
          I.val(E.format(q)),
          i.data("date", E.format(q)),
          (W = !1),
          y(),
          m({ type: "dp.change", date: E.clone(), oldDate: t }))
        : (p.keepInvalid
            ? m({ type: "dp.change", date: e, oldDate: t })
            : I.val(W ? "" : E.format(q)),
          m({ type: "dp.error", date: e, oldDate: t }));
    }
    function b() {
      var t = !1;
      return N
    ...
    function v(e) {
      return (
        void 0 === p.parseInputDate
          ? (!_.isMoment(e) || e instanceof Date) && (e = c(e))
          : (e = p.parseInputDate(e)),
        e
      );
    }
    function k(e) {
      return (
        $(e.currentTarget).is(".disabled") ||
          X[$(e.currentTarget).data("action")].apply(L, arguments),
        !1
      );
    }
    function D() {
        ...
        I.prop("disabled") ||
          ...
          (function () {
            ...
            for (
              ...
              t.isBefore(H.clone().endOf("w"));

            )
              e.append($("<th>").addClass("dow").text(t.format("dd"))),
                t.add(1, "d");
            N.find(".datepicker-days thead").append(e);
          })(),
          (function () {
            for (
              var e = [], t = H.clone().startOf("y").startOf("d");
              t.isSame(H, "y");
    ...
    function x(e) {
      ...
      for (t in p.keyBinds)
        if (
          p.keyBinds.hasOwnProperty(t) &&
          "function" == typeof p.keyBinds[t] &&
          (n = t.split(" ")).length === o.length &&
          J[d] === n[n.length - 1]
        ) {
    ...
    function P() {
      ...
      (q = e.replace(
        ...
        function (e) {
          return (E.localeData().longDateFormat(e) || e).replace(
            /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,
            function (e) {
        ...
        (B = p.extraFormats ? p.extraFormats.slice() : []).indexOf(e) < 0 &&
          B.indexOf(q) < 0 &&
          B.push(q),
        (Y =
          q.toLowerCase().indexOf("a") < 1 &&
          q.replace(/\[.*?\]/g, "").indexOf("h") < 1),
        d("y") && (V = 2),
        d("M") && (V = 1),
        d("d") && (V = 0),
        (j = Math.max(V, j)),
    ...
    var E,
      ...
      X = {
        ...
        selectMonth: function (e) {
          ...
          H.month(t),
            j === V
              ? (w(E.clone().year(H.year()).month(H.month())), p.inline || b())
              : (o(-1), s()),
            r("M");
        },
        selectYear: function (e) {
          ...
          H.year(t),
            j === V
              ? (w(E.clone().year(H.year())), p.inline || b())
              : (o(-1), s()),
            r("YYYY");
        },
        ...
        selectDay: function (e) {
          var t = H.clone();
          $(e.target).is(".old") && t.subtract(1, "M"),
            $(e.target).is(".new") && t.add(1, "M"),
            w(t.date(parseInt($(e.target).text(), 10))),
            l() || p.keepOpen || p.inline || b();
        },
        ...
        togglePicker: function (e) {
          ...
          if (i && i.length) {
            ...
            i.collapse
              ? (i.collapse("hide"), o.collapse("show"))
              : (i.removeClass("show"), o.addClass("show")),
              a.is("i")
                ? a.toggleClass(p.icons.time + " " + p.icons.date)
                : a.find("i").toggleClass(p.icons.time + " " + p.icons.date),
              a.hasClass(p.icons.date)
                ? n.attr("title", p.tooltips.selectDate)
                : n.attr("title", p.tooltips.selectTime);
          }
        },
        showPicker: function () {
        ...
        selectHour: function (e) {
          ...
          Y || (12 <= E.hours() ? 12 !== t && (t += 12) : 12 === t && (t = 0)),
            w(E.clone().hours(t)),
            X.showPicker.call(L);
        },
        selectMinute: function (e) {
          w(E.clone().minutes(parseInt($(e.target).text(), 10))),
            X.showPicker.call(L);
        },
        selectSecond: function (e) {
          w(E.clone().seconds(parseInt($(e.target).text(), 10))),
            X.showPicker.call(L);
        },
        clear: g,
        today: function () {
    ...
    if (
      ((L.destroy = function () {
        b(),
          ...
          i.is("input")
            ? I.off({ focus: D })
            : z && (z.off("click", C), z.off("mousedown", !1)),
      ...
      (L.disable = function () {
        return (
          b(),
          z && z.hasClass("btn") && z.addClass("disabled"),
          I.prop("disabled", !0),
          L
        );
      }),
      (L.enable = function () {
        return (
          z && z.hasClass("btn") && z.removeClass("disabled"),
          I.prop("disabled", !1),
          L
        );
      }),
      ...
      (L.disabledDates = function (e) {
        if (0 === arguments.length)
          return p.disabledDates
            ? $.extend({}, p.disabledDates)
            : p.disabledDates;
      ...
      (L.enabledDates = function (e) {
        if (0 === arguments.length)
          return p.enabledDates ? $.extend({}, p.enabledDates) : p.enabledDates;
      ...
      (L.daysOfWeekDisabled = function (e) {
        ...
        if ("boolean" == typeof e && !e)
          return (p.daysOfWeekDisabled = !1), y(), L;
        if (!(e instanceof Array))
          throw new TypeError(
      ...
      (L.maxDate = function (e) {
        if (0 === arguments.length)
          return p.maxDate ? p.maxDate.clone() : p.maxDate;
        ...
        if (p.minDate && t.isBefore(p.minDate))
          throw new TypeError(
            "maxDate() date parameter is before options.minDate: " + t.format(q)
          );
        return (
          (p.maxDate = t),
          p.useCurrent && !p.keepInvalid && E.isAfter(e) && w(p.maxDate),
          H.isAfter(t) && (H = t.clone().subtract(p.stepping, "m")),
          y(),
          L
        );
      }),
      (L.minDate = function (e) {
        if (0 === arguments.length)
          return p.minDate ? p.minDate.clone() : p.minDate;
        if ("boolean" == typeof e && !1 === e) return (p.minDate = !1), y(), L;
        "string" == typeof e && (("now" !== e && "moment" !== e) || (e = c()));
        var t = v(e);
        if (!t.isValid())
          throw new TypeError("minDate() Could not parse date parameter: " + e);
        if (p.maxDate && t.isAfter(p.maxDate))
          throw new TypeError(
            "minDate() date parameter is after options.maxDate: " + t.format(q)
          );
        return (
          (p.minDate = t),
          p.useCurrent && !p.keepInvalid && E.isBefore(e) && w(p.minDate),
          H.isBefore(t) && (H = t.clone().add(p.stepping, "m")),
          y(),
          L
        );
      }),
      (L.defaultDate = function (e) {
        if (0 === arguments.length)
          return p.defaultDate ? p.defaultDate.clone() : p.defaultDate;
        if (!e) return (p.defaultDate = !1), L;
        "string" == typeof e &&
          (e = "now" === e || "moment" === e ? c() : c(e));
        var t = v(e);
        if (!t.isValid())
          throw new TypeError(
        ...
        return (
          (p.defaultDate = t),
          ((p.defaultDate && p.inline) || "" === I.val().trim()) &&
            w(p.defaultDate),
          L
        );
      }),
      ...
      (L.widgetParent = function (e) {
        ...
        if (
          ("string" == typeof e && (e = $(e)),
          null !== e && "string" != typeof e && !(e instanceof $))
        )
          throw new TypeError(
      ...
      (L.disabledTimeIntervals = function (e) {
        if (0 === arguments.length)
          return p.disabledTimeIntervals
            ? $.extend({}, p.disabledTimeIntervals)
            : p.disabledTimeIntervals;
      ...
      (L.disabledHours = function (e) {
        if (0 === arguments.length)
          return p.disabledHours
            ? $.extend({}, p.disabledHours)
            : p.disabledHours;
      ...
      (L.enabledHours = function (e) {
        if (0 === arguments.length)
          return p.enabledHours ? $.extend({}, p.enabledHours) : p.enabledHours;
      ...
      (L.viewDate = function (e) {
        ...
        if (!("string" == typeof e || _.isMoment(e) || e instanceof Date))
          throw new TypeError(
    ...
    if (
      (i.hasClass("input-group") &&
        (0 === i.find(".datepickerbutton").length
          ? 0 === (z = i.find(".input-group-text")).length &&
            (z = i.find(".input-group-addon"))
          : (z = i.find(".datepickerbutton"))),
      !p.inline && !I.is("input"))
    )
      throw new Error(
    ...
    return (
      ...
      $.extend(
        ...
        p,
        ((A = {}),
        (F = i.is("input") || p.inline ? i.data() : i.find("input").data())
          .dateOptions &&
          F.dateOptions instanceof Object &&
          (A = $.extend(!0, A, F.dateOptions)),
        $.each(p, function (e) {
      ...
      i.is("input")
        ? I.on({ focus: D })
        : z && (z.on("click", C), z.on("mousedown", !1)),
      I.prop("disabled") && L.disable(),
      I.is("input") && 0 !== I.val().trim().length
        ? w(v(I.val().trim()))
        : p.defaultDate && void 0 === I.attr("placeholder") && w(p.defaultDate),
      p.inline && D(),
      L
    );
  }
    ...
    ($.fn.datetimepicker = function (a) {
      ...
      if ("object" == typeof a)
        return this.each(function () {
          ...
          t.data("DateTimePicker") ||
            ((e = $.extend(!0, {}, $.fn.datetimepicker.defaults, a)),
      ...
      if ("string" == typeof a)
        return (
          ...
          r || -1 < $.inArray(a, ["destroy", "hide", "show", "toggle"])
            ? this
            : t
        );
